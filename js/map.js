...
const WORLD = {
  ...
  locations: {
    ...
    whispering_cliffs: {
      ...
      x: 9.8, y: 4.6,
      paths: ['misthaven_village', 'the_veering', 'shore_market'],
    ...
    shore_market: {
      ...
      type: LOC_TYPES.SHOP,
      x: 12, y: 3.5,
      paths: ['whispering_cliffs', 'the_wild_shore', 'reef_shallows'],
    ...
    reef_shallows: {
      ...
      type: LOC_TYPES.REST,
      x: 13.1, y: 1.7,
      paths: ['windward_lighthouse', 'shore_market', 'thornwood_gate'],
    ...
    the_wild_shore: {
      ...
      type: LOC_TYPES.BATTLE,
      x: 14.4, y: 2,
      paths: ['shore_market', 'thornwood_gate'],
    ...
    thornwood_gate: {
      ...
      x: 16.3, y: 3.3,
      paths: ['the_wild_shore', 'reef_shallows'],
