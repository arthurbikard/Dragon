...
const WORLD = {
  ...
  locations: {
    ...
    warded_pass: {
      ...
      type: LOC_TYPES.BATTLE,
      x: 30.5, y: 4.8,
      paths: ['forest_heart', 'rope_bridge', 'mountain_shrine'],
    ...
    rope_bridge: {
      ...
      type: LOC_TYPES.EVENT,
      x: 32.2, y: 3.6,
      paths: ['warded_pass', 'abandoned_mine', 'echo_cave'],
    ...
    mountain_shrine: {
      ...
      type: LOC_TYPES.NPC,
      x: 33.0, y: 6.1,
      paths: ['warded_pass', 'abandoned_mine'],
    ...
    abandoned_mine: {
      ...
      type: LOC_TYPES.BATTLE,
      x: 34.5, y: 5.1,
      paths: ['rope_bridge', 'mountain_shrine', 'echo_cave', 'storm_peak'],
    ...
    echo_cave: {
      ...
      type: LOC_TYPES.EVENT,
      x: 36.5, y: 3.5,
      paths: ['rope_bridge', 'abandoned_mine', 'eagles_nest', 'storm_peak'],
    ...
    eagles_nest: {
      ...
      type: LOC_TYPES.REST,
      x: 38.0, y: 2.1,
      paths: ['echo_cave', 'storm_peak', 'summit_camp'],
    ...
    storm_peak: {
      ...
      type: LOC_TYPES.ELITE,
      x: 39.8, y: 4.4,
      paths: ['abandoned_mine', 'echo_cave', 'eagles_nest', 'summit_camp', 'crystal_cavern'],
    ...
    summit_camp: {
      ...
      type: LOC_TYPES.SHOP,
      x: 41.8, y: 5.8,
      paths: ['eagles_nest', 'storm_peak', 'crystal_cavern'],
    ...
    crystal_cavern: {
      ...
      x: 43.8, y: 3.4,
      paths: ['storm_peak', 'summit_camp', 'skyfall_temple'],
