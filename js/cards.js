...
const CARD_TEMPLATES = {
  ...
  spore_burst: {
    ...
    description: 'Deal 4 damage. Apply Weak for 2 turns.',
    image: 'images/card_earthquake.png',
  },
  natures_wrath: {
    name: "Nature's Wrath",
    ...
    damage: 8,
    block: 0,
    effects: [{ type: 'vulnerable', value: 1, duration: 2 }, { type: 'thorns', value: 2, duration: 2 }],
    description: 'Deal 8 damage. Apply Vulnerable 2t. Gain 2 Thorns 2t.',
    image: 'images/card_earthquake.png',
  },
  bark_armor: {
    name: 'Bark Armor',
    ...
    damage: 0,
    block: 5,
    effects: [{ type: 'thorns', value: 2, duration: 2 }],
    description: 'Gain 5 Block. Gain 2 Thorns 2t.',
    image: 'images/card_stone_wall.png',
  },
  rejuvenate: {
    name: 'Rejuvenate',
    ...
    damage: 0,
    block: 0,
    effects: [{ type: 'heal', value: 4 }, { type: 'cleanse' }],
    description: 'Heal 4 HP. Cleanse all debuffs.',
    image: 'images/card_fortify.png',
  },
